...
class _BodyState extends State<Body>{
  final PilotStream pilotStream = PilotStream();
  List pilots;
          ...
          if (snapshot.hasData) {
            ...
            return Row(
              ...
              children: <Widget>[
                Expanded(
                  flex: 8,
                  child: RequestPilotShortDetailCard(
                    requestId: pilot.id,
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => RequestDetailsScreen(requestId: requestId),),);
                    },
                  ),
                ),
                SizedBox(width: 10),
