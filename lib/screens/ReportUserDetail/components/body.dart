        ...
        child: Padding(
          ...
          child: FutureBuilder<ReportedUser>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ReportedUser requestData = snapshot.data;
                String reportId = requestData.id;
                String reportUserName = requestData.userName;
                String userNameReported = requestData.reportedUser;
                ...
                return SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Align(
                        child: Text("User Report Details", style: headingStyle),
                      ),
                      SizedBox(height: 10),
                      Text(
                        "Report Id: $reportId",
                      ...
                      Text.rich(
                        TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: "Reported Username : $userNameReported\n",
                                style: TextStyle(
                                  color: kTextColor,
