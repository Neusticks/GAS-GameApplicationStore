...
class Body extends StatefulWidget {
  ...
  Body({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => BodyState(peerId: peerId, peerAvatar: peerAvatar);
}

class BodyState extends State<Body> {
  BodyState({Key key, @required this.peerId, @required this.peerAvatar});
  String peerAvatar;
  String peerId;
  String id;
  ...
  readLocal() async {
    ...
    id = AuthentificationService().currentUser.uid;
  ...
  void onSendMessage(String content, int type) {
    ...
    if (content.trim() != '') {
      ...
      snackbarMessage = "Nothing to send";
    }
  }
